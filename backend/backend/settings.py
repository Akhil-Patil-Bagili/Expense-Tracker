...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # Place it at the beginning
...
STATIC_URL = '/static/'  # Use /static/ instead of 'static/'
...
# CORS settings
CORS_ORIGIN_ALLOW_ALL = True  # Allow all origins for development, you may want to restrict it in production
